<%@ Page Title="" Language="C#" MasterPageFile="~/Basic.master" AutoEventWireup="true" CodeFile="SignUp.aspx.cs" Inherits="SignUp" %>
                    ...
                    <div class="col-12">
                        <div class="row" >                            
                            <div class="col-6" style="background-color :#f77d74">
                                <a href="SignUp.aspx"><h2 align="center" style ="color: white">SignUp</h2></a>
                            </div>
                            <div class="col-6">
                                <a href="Authentication.aspx"><h2 align="center" style ="color: grey">Login</h2></a>
                            </div>
                        </div>
